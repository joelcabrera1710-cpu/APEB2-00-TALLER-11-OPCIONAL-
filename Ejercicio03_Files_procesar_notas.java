...
public class Ejercicio03_Files_procesar_notas {
    public static void main(String[] args) {
        ...
        int bajosMedia = Debajo_de_la_media(MatrizNotasINP, MatrizNotasOUT);
        persistir_resultados("NotasOut.csv",MatrizNotasINP, MatrizNotasOUT, Pasaron, Quedados, bajosMedia);


    }
    public static void persistir_resultados (String nombreArchivoOut, String MatrizNotasINP[][], String MatrizNotasOUT[][], int Pasaron, int Quedados, int bajosMedia){
        try {
    ...
    public static String [][] ProcesarNotasINP(String MatrizNotasINP[][],
        ...
        for (int i = 0; i < MatrizNotasINP.length; i++) {
            ...
            datosNotas [i][0] = String.format("%.2f",promedio).replace(",",".");
...
// contador quienes aprobaron
   ...
   public static int Debajo_de_la_media(String MatrizNotasINP[][],String MatrizNotasOUT[][]){
       double suma_promedios = 0;
       double promedio_general;
       int contador_bajos = 0;
       for (int i = 0; i < MatrizNotasOUT.length; i++) {
           suma_promedios += Double.parseDouble(MatrizNotasOUT[i][0].replace(",","."));
       }
       promedio_general = suma_promedios / MatrizNotasOUT.length;
       System.out.println("ESTUD DEBAJO LA MEDIA "  + String.format("%.2f ",promedio_general));
       for (int i = 0; i < MatrizNotasOUT.length; i++) {
           double prom_indi = Double.parseDouble(MatrizNotasOUT[i][0]);
           if ( prom_indi < promedio_general){
               contador_bajos ++;
               System.out.println("El estudiante "+MatrizNotasINP[i][0]+" tiene de promdio: " +prom_indi);
           }
       }
       return contador_bajos;
   }
}
/**
 * ESTUD DEBAJO LA MEDIA 5,65 
El estudiante Est 2 tiene de promdio: 5.5
El estudiante Est 5 tiene de promdio: 5.5
El estudiante Est 6 tiene de promdio: 3.0
El estudiante Est 7 tiene de promdio: 5.0
El estudiante Est 8 tiene de promdio: 5.0
El estudiante Est 9 tiene de promdio: 3.0
